...
export function JetskiNew() {
  ...
  async function handleSaveData() {
    ...
    try {
      ...
      history.push('/jetski/infos');
      toast.success(`${response.data.name} agora é um jetski sobre os cuidados da EnosNautica.`);
    } catch (error) {
  ...
  return (
    <Container>
      <HeaderMain title="Crie um Jetski" />
